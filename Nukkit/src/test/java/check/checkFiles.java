...
public class checkFiles {
    ...
    public void checkPluginDotYmlFile() {
        ...
        ConfigSection permissionsSection = config.getSections("permissions").getAll();
        for (PermissionsInfo permissionInfo: PermissionsInfo.values()) {
            Map<String, Object> permissionMap = permissionsSection.getSection(permissionInfo.getPermission()).getAllMap();
